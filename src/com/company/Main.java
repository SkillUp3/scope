...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ScopeCheck mScopeCheck = new ScopeCheck();
        System.out.println(mScopeCheck.getPrivateVar());

        System.out.println("***************");
        System.out.println(privateVar);
        System.out.println("***************");
        mScopeCheck.timesTwo();
        System.out.println("***************");
        ScopeCheck.InnerClass innerClass = mScopeCheck.new InnerClass();
        System.out.println("***************");
        innerClass.timesTwo();
